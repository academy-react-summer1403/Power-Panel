...
// ** Table Columns
import { CourseLevelColumns } from "../@core/components/CourseLevelList/cloumns";

import { GetStatusApi } from "../core/services/api/StatusApi";
...
import { StatusColumns } from "../@core/components/StatusList/cloumns";
  ...
  const handleFilter = (val) => {
    textTimeOut(() => {
      ...
      const filtered = courseLevel.filter((item) =>
        item.statusName.toLowerCase().includes(val.toLowerCase()) 
      );
