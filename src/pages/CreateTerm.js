...
const CreateTerm = () => {
  ...
  const Validation = yup.object().shape({
    ...
    startDate: yup.date().required("این فیلد الزامی است").typeError("فرمت تاریخ معتبر نیست"),
    endDate: yup.date().required("این فیلد الزامی است").typeError("فرمت تاریخ معتبر نیست"),
  });
  ...
  />
  {errors.departmentId && (
    <FormFeedback className="d-block">{errors.departmentId.message}</FormFeedback>
  )}
</FormGroup>
