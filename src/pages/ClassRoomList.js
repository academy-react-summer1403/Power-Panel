...
// ** Table Columns
import { ClassRoomColumns } from "../@core/components/ClassRoom/cloumns";

import { GetClassRoomApi } from "../core/services/api/ClassRoomApi";
    ...
    <div className="invoice-list-table-header w-100 py-2">
      <Row>
        <Col lg="6" className="d-flex align-items-center px-0 px-lg-1">
          ...
          <Button tag={Link} to="/CreateClassRoom" color="primary">
            افزودن دوره
          </Button>
        </Col>
        <Col
