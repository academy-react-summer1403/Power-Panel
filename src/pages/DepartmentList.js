...
// ** Table Columns
import { DepCloumns } from "../@core/components/DepartmentList/DepCloumns";
    ...
    <div className="invoice-list-table-header w-100 py-2">
      <Row>
        <Col lg="6" className="d-flex align-items-center px-0 px-lg-1">
          ...
          <Button tag={Link} to="/CreateDepatment" color="primary">
            افزودن دوره
          </Button>
        </Col>
        <Col
...
const DepartmentList = () => {
  ...
  const handleFilter = (val) => {
    textTimeOut(() => {
      ...
      const filtered = Depatment.filter((item) =>
        item.depName.toLowerCase().includes(val.toLowerCase()) 
      );
