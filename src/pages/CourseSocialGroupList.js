...
// ** Table Columns
import { CourseSocialGroupColumns } from "../@core/components/CourseSocialGroupList/cloumns";

// ** Core import
import { GetCourseSocialGroupApi } from "../core/services/api/CourseSocialGroupApi";
        ...
        >
          <div className="d-flex align-items-center">
            <Input
              ...
              placeholder="جستجوی گروه اجتماعی دوره ها"
            />
          </div>
        </Col>
      </Row>
  ...
  useEffect(() => {
    const fetchCourseLevel = async () => {
      try {
        ...
        toast.error("ارور در دریافت داده‌ها");
      }
    };
      ...
      <Card>
        <div className="invoice-list-dataTable react-dataTable">
          <DataTable
            ...
            paginationServer
            subHeader={true}
            columns={CourseSocialGroupColumns}
            responsive={true}
            onSort={handleSort}
            data={dataToRender()}
