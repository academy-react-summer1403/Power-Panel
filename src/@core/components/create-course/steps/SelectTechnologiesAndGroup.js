...
// ** Core Imports
import { addTech } from "../../../../core/services/api/CourseApi";
...
const SelectTechnologiesAndGroup = ({
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const addTechnology = await addTech(courseId, convertTechnologies);
      ...
      if (addTechnology.success && addCourseGroup.success) navigate("/CourseList");
    } catch (error) {
      setLoading(false);
