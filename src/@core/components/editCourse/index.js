...
// ** Steps
import Describe from "../create-course/steps/Describe";
import AdvanceData from "../create-course/steps/AdvanceData";
import CourseFeatures from "..//create-course/steps/CourseFeatures";
import GlobalData from "../create-course/steps/GlobalData";

// ** Core Imports
import { GetEditCourse } from "../../../core/services/api/CourseApi";
import { UpdateCourse } from "../../../core/services/api/CourseApi";
...
const EditCourseWizard = () => {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      const createCourse = await UpdateCourse(formData);
  ...
  useEffect(() => {
    const getEditCourse = async () => {
      try {
        const response = await GetEditCourse(id);
