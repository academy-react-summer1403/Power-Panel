...
// ** Core Imports
import { GetCourseReserveByIdAPI } from "../../../../core/services/api/CourseApi";
...
// ** Columns
import { CourseReservedColumns } from "../../courselist-columns/courseReservedColumns";
...
const CourseReserve = () => {
  ...
  useEffect(() => {
    const fetchCourseReserve = async () => {
      try {
        const getCourseReserve = await GetCourseReserveByIdAPI(id);
    ...
    <Card>
      ...
      <div className="react-dataTable user-view-account-projects">
        ...
        <DataTable
          ...
          columns={CourseReservedColumns(`/courses/${id}`)}
