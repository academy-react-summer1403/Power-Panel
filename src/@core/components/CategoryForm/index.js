...
// ** Core Imports
import { createNewsCatAPI } from "../../../core/services/api/NewsApi";
import { updateNewsCatAPI } from "../../../core/services/api/NewsApi";
import { FormVal } from "../../../core/Validation/News/catVal";
  ...
  const onSubmit = async (values) => {
    try {
      ...
      const sendCategory = category
        ? await updateNewsCatAPI(data)
        : await createNewsCatAPI(data);
